...
PARAM  <- list()
PARAM$experimento <- "FE7310-final"

PARAM$exp_input  <- "DR7210-final"
...
PARAM$RandomForest$semilla  <- 101009   # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 101009   # cambiar por la propia semilla
