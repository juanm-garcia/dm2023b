...
PARAM <- list()
PARAM$experimento <- "TS6410_ExpB_03"
...
PARAM$train$training <- c(
  202010, 202009, 202008, 202007, 202002, 202001, 201912,
  201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903,
  201902, 201901
)

PARAM$train$validation <- c(202011, 202012)
PARAM$train$testing <- c(202101, 202102)
