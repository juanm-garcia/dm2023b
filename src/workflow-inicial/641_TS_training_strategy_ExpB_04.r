...
PARAM <- list()
PARAM$experimento <- "TS6410_ExpB_04"

PARAM$exp_input <- "FE6310_ExpB_01"
...
PARAM$train$training <- c(
  202114, 202103, 202102, 202101, 202012, 202011, 202010,
  202009, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907,
  201906, 201905
)

PARAM$train$validation <- c(202006)
PARAM$train$testing <- c(202007, 202008)
